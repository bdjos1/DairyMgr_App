...
var specHelper = (function() {
    ...
    var service = {
        ...
        fakePostRequest: fakePostRequest,
		mockI18nCalls : mockI18nCalls,
    ...
    function fakePostRequest(callbackObj, callback, url, fxParam1, fxParam2) {
    	// TODO: Handle return properly
    	callback.apply(callbackObj, [url, fxParam1, fxParam2]).then(function(data) {
    		specHelper.responseData = data;
    	  //return responseData;
        }).catch(function(error) {
        	specHelper.responseData = error;
          //return responseData;
        });
